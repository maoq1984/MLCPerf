...
double acc(int a, int b, int c, int d)
{
...
double prec_loss(int a, int b, int c, int d)
{
	return(100.0*(1.0-prec(a,b,c,d)));
}

double rec_loss(int a, int b, int c, int d)
{
	return(100.0*(1.0-rec(a,b,c,d)));
}

double accuracy_loss(int a, int b, int c, int d)
{
	return(100.0*(1.0-acc(a,b,c,d)));
}
